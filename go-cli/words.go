...
func registerSDKWords(r *eng.Registry, client *sdk.NarutoCharacterSDK) {
...
func runOp(client *sdk.NarutoCharacterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
