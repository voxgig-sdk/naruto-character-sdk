...
AQL-driven CLI and REPL for the NarutoCharacter SDK. Positional arguments are
...
```sh
go build -o naruto-character-cli ./...
```
...
./naruto-character-cli load 1 character
./naruto-character-cli load '{id:1}' character
