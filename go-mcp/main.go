// Command NarutoCharacter-mcp is an MCP server exposing the NarutoCharacter
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NarutoCharacter_list  — list records of an entity
//	NarutoCharacter_load  — load a single record of an entity
//
