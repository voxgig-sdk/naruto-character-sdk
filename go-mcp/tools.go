...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | clan"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NarutoCharacterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "naruto-character_list",
		Description: "List records from NarutoCharacter. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "naruto-character_load",
		Description: "Load a single record from NarutoCharacter. " +
...
func runOp(client *sdk.NarutoCharacterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NarutoCharacterSDK, name string) (sdk.NarutoCharacterEntity, error) {
	switch strings.ToLower(name) {
	case "character":
		return client.Character(nil), nil
	case "clan":
		return client.Clan(nil), nil
