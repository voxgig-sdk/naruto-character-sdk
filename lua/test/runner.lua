...
function runner.env_override(m)
  local live = runner.getenv("NARUTO_CHARACTER_TEST_LIVE")
  local override = runner.getenv("NARUTO_CHARACTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NARUTO_CHARACTER_TEST_EXPLAIN")
