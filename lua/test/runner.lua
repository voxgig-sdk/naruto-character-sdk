...
function runner.env_override(m)
  local live = runner.getenv("NARUTOCHARACTER_TEST_LIVE")
  local override = runner.getenv("NARUTOCHARACTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NARUTOCHARACTER_TEST_EXPLAIN")
