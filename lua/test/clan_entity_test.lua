...
describe("ClanEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Clan(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Clan(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set NARUTO_CHARACTER_TEST_CLAN_ENTID JSON to run live")
      return
    end
...
function clan_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("NARUTO_CHARACTER_TEST_CLAN_ENTID")
  ...
  if env["NARUTO_CHARACTER_TEST_LIVE"] == "TRUE" then
