...
describe("ClanDirect", function()
  it("should direct-list-clan", function()
    local setup = clan_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-clan", setup.live and "live" or "unit")
