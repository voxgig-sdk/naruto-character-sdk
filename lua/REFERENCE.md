# NarutoCharacter Lua SDK Reference

Complete API reference for the NarutoCharacter Lua SDK.
...
```lua
local results, err = client:Clan(nil):list(nil, nil)
```
