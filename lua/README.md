...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/naruto-character-sdk/releases)),
...
Create an instance: `local clan = client:Clan(nil)`
...
```lua
local clans, err = client:Clan():list()
```
