# NarutoCharacter SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NarutoCharacterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NarutoCharacterSDK(...) and NarutoCharacterSDK.test(...) become
#      NarutoCharacterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "narutocharacter_sdk"
_SDK_CLASS = "NarutoCharacterSDK"
