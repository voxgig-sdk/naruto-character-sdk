...
from narutocharacter_sdk.utility.voxgig_struct.voxgig_struct import (
...
runner = makeRunner(STRUCT_TEST_JSON, NarutoCharacterSDK.test(None, None))
...
class TestStructUtility(unittest.TestCase):
    ...
    def test_minor_joinurl(self):
        from narutocharacter_sdk.utility.voxgig_struct.voxgig_struct import join as struct_join
