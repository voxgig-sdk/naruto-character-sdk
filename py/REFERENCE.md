# NarutoCharacter Python SDK Reference

Complete API reference for the NarutoCharacter Python SDK.
...
#### `NarutoCharacterSDK.test(testopts=None, sdkopts=None)`
...
Create a new `ClanEntity` instance. Pass `None` for no initial data.
...
Create a new `ClanEntity` instance with the same options.
