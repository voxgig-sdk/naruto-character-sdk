...
from narutocharacter_sdk.utility import register

# Load features
from narutocharacter_sdk.feature.base_feature import NarutoCharacterBaseFeature
from narutocharacter_sdk.features import _has_feature, _make_feature
...
class NarutoCharacterSDK:
    ...
    def get_utility(self):
        return NarutoCharacterUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NarutoCharacterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from narutocharacter_sdk.entity.character_entity import CharacterEntity
        return CharacterEntity(self, data)


    def Clan(self, data=None) -> "ClanEntity":
        """Entity factory: client.Clan().list() / client.Clan().load({"id": ...})."""
        from narutocharacter_sdk.entity.clan_entity import ClanEntity
