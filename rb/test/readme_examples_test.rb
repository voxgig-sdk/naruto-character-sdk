...
#      offline in seeded test mode (NarutoCharacterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NarutoCharacter_sdk.rb")
  SDK_CLASS = "NarutoCharacterSDK"
