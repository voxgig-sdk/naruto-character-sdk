...
class ClanEntity
  ...
  #
  # @param reqmatch [ClanListMatch, Hash, nil] match filter (any subset of
  #   Clan fields); defaults to nil, treated as an empty match that lists all.
