...
// NarutoCharacter SDK idempotency feature
...
class NarutoCharacterIdempotencyFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _mutating(NarutoCharacterContext $ctx): bool
    {
