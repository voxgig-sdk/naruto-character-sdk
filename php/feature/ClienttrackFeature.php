...
// NarutoCharacter SDK clienttrack feature
...
class NarutoCharacterClienttrackFeature extends NarutoCharacterBaseFeature
{
    ...
    public function PostConstruct(NarutoCharacterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NarutoCharacter-SDK';
