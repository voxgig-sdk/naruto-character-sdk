...
// NarutoCharacter SDK timeout feature
...
class NarutoCharacterTimeoutFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _with_timeout(NarutoCharacterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NarutoCharacterContext $_ctx, float $ms): void
    {
        $client = $this->client;
