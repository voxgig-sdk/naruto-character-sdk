...
// NarutoCharacter SDK streaming feature
...
class NarutoCharacterStreamingFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _iterate(NarutoCharacterResult $result): \Generator
    {
    ...
    private function _streamable(NarutoCharacterContext $ctx): bool
    {
