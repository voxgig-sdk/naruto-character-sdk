...
// NarutoCharacter SDK proxy feature
...
class NarutoCharacterProxyFeature extends NarutoCharacterBaseFeature
{
    ...
    public function init(NarutoCharacterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NarutoCharacterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
