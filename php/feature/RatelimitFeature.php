...
// NarutoCharacter SDK ratelimit feature
...
class NarutoCharacterRatelimitFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _acquire(NarutoCharacterContext $ctx): void
    {
    ...
    private function _track(NarutoCharacterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
