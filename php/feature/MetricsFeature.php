...
// NarutoCharacter SDK metrics feature
...
class NarutoCharacterMetricsFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _record(NarutoCharacterContext $ctx, bool $ok): void
    {
