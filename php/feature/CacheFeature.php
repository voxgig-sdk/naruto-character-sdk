...
// NarutoCharacter SDK cache feature
...
class NarutoCharacterCacheFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _through(NarutoCharacterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
