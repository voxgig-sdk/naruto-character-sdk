...
// NarutoCharacter SDK utility type

class NarutoCharacterUtility
{
    ...
    public static function copy(NarutoCharacterUtility $src): NarutoCharacterUtility
    {
        $u = new NarutoCharacterUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
