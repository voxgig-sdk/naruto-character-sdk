...
// NarutoCharacter SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NarutoCharacterSDK::test)
...
{
    private const SDK_CLASS = 'NarutoCharacterSDK';
    ...
    private const SDK_BASE = 'narutocharacter_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../narutocharacter_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
