...
// NarutoCharacter SDK utility: fetcher

class NarutoCharacterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NarutoCharacterSDK/1.0)';
    ...
    public static function call(NarutoCharacterContext $ctx, string $fullurl, array $fetchdef): array
    {
