...
// NarutoCharacter SDK utility: make_options

class NarutoCharacterMakeOptions
{
    ...
    public static function call(NarutoCharacterContext $ctx): array
    {
        ...
        //
        // `NarutoCharacterSchema::optspec()` is built from the model:
        ...
        $optspec = NarutoCharacterSchema::optspec();
