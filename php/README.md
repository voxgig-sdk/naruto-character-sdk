# NarutoCharacter PHP SDK



The PHP SDK for the NarutoCharacter API — an entity-oriented client using PHP conventions.
...
```php
// list() returns an array of Clan records (throws on error).
...
```
php/
├── narutocharacter_sdk.php          -- Main SDK class
...
The main class (`narutocharacter_sdk.php`) exports the SDK class
