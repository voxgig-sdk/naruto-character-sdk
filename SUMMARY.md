...
Results: Successful response with list of clans.
...
| Clan | `list` | `GET /clan` | See reference |

## Connect to the API

- Production server: `https://narutodb.xyz/api`
...
- `naruto-character_list`: List records for an entity. Supported entities: `character`, `clan`.
- `naruto-character_load`: Load one record for an entity. Supported entities: `character`.
