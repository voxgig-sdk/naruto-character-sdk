...
function envOverride(m) {
    if ('TRUE' === process.env.NARUTO_CHARACTER_TEST_LIVE ||
        'TRUE' === process.env.NARUTO_CHARACTER_TEST_OVERRIDE) {
    ...
    m.NARUTO_CHARACTER_TEST_EXPLAIN = process.env.NARUTO_CHARACTER_TEST_EXPLAIN || m.NARUTO_CHARACTER_TEST_EXPLAIN;
    return m;
}
