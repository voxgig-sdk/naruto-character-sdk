...
(0, node_test_1.describe)('ClanDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NarutoCharacterSDK({
    ...
    (0, node_test_1.test)('direct-list-clan', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-clan', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.NARUTO_CHARACTER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NarutoCharacterSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NARUTO_CHARACTER_TEST_CLAN_ENTID'];
    ...
    const client = new __1.NarutoCharacterSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ClanDirect.test.js.map