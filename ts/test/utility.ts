...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.NARUTOCHARACTER_TEST_LIVE ||
    'TRUE' === process.env.NARUTOCHARACTER_TEST_OVERRIDE
  ) {
  ...
  m.NARUTOCHARACTER_TEST_EXPLAIN = process.env.NARUTOCHARACTER_TEST_EXPLAIN || m.NARUTOCHARACTER_TEST_EXPLAIN
