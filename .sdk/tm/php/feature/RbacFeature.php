...
// NarutoCharacter SDK rbac feature
...
class NarutoCharacterRbacFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _required(NarutoCharacterContext $ctx): ?string
    {
    ...
    private function _reject(NarutoCharacterContext $ctx, string $required): void
    {
    ...
    private function _track(NarutoCharacterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
