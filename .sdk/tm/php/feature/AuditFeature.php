...
// NarutoCharacter SDK audit feature
...
class NarutoCharacterAuditFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _emit(NarutoCharacterContext $ctx, string $outcome): void
    {
