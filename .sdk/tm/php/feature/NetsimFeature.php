...
// NarutoCharacter SDK netsim feature
...
class NarutoCharacterNetsimFeature extends NarutoCharacterBaseFeature
{
    ...
    private function _simulate(NarutoCharacterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NarutoCharacterContext $ctx, array $applied): void
    {
        $client = $this->client;
