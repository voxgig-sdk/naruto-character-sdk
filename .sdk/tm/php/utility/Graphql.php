...
// NarutoCharacter SDK utility: graphql
//
...
class NarutoCharacterGraphql
{
    ...
    // equivalent.
    public static function body(NarutoCharacterContext $ctx): mixed
    {
    ...
    public static function errors(NarutoCharacterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
