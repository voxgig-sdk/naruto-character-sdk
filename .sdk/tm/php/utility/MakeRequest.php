...
// NarutoCharacter SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NarutoCharacterMakeRequest
{
    public static function call(NarutoCharacterContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NarutoCharacterResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NarutoCharacterResponse($fetched);
        } else {
