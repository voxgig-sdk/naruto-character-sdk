...
// NarutoCharacter SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NarutoCharacterOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NarutoCharacterOmni::structfix($now, Struct::undef()))
                        !== json_encode(NarutoCharacterOmni::structfix($val, Struct::undef()))) {
