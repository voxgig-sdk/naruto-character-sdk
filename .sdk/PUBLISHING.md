...
|---|---|---|
| `ts/` | @voxgig-sdk/naruto-character-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/naruto-character-sdk \
      --repository voxgig-sdk/naruto-character-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/naruto-character-sdk` shows it, and
`npm trust revoke @voxgig-sdk/naruto-character-sdk --id=<id>` removes it.
