...
The NarutoDB API offers a detailed database of characters, clans, villages, and more from the Naruto anime and manga series.

Learn more about Naruto Character API at [narutodb.xyz](https://narutodb.xyz).
...
This SDK exposes the API as a small set of **semantic entities** — Character and Clan — that you
...
| **Clan** | The Clan entity (list). | `/clan` |
