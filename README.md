...
This is an unofficial SDK for the Naruto Character public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/naruto-character` | `npm install @voxgig-sdk/naruto-character` |
| Python | `voxgig-sdk-naruto-character` | `pip install voxgig-sdk-naruto-character` |
| PHP | `voxgig-sdk/naruto-character` | `composer require voxgig-sdk/naruto-character` |
| Golang | `github.com/voxgig-sdk/naruto-character-sdk/go` | `go get github.com/voxgig-sdk/naruto-character-sdk/go` |
| Ruby | `voxgig-sdk-naruto-character` | `gem install voxgig-sdk-naruto-character` |
| Lua | `voxgig-sdk-naruto-character` | `luarocks install voxgig-sdk-naruto-character` |
