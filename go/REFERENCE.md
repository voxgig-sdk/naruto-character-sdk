# NarutoCharacter Golang SDK Reference

Complete API reference for the NarutoCharacter Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *NarutoCharacterSDK`
...
#### `Character(data map[string]any) NarutoCharacterEntity`

Create a new `Character` entity instance. Pass `nil` for no initial data.

#### `Clan(data map[string]any) NarutoCharacterEntity`
...
| `family` | `map[string]any` | No | Character's family members and relationships |
