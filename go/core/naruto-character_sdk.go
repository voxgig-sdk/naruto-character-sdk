...
type NarutoCharacterSDK struct {
	Mode     string
...
func (sdk *NarutoCharacterSDK) OptionsMap() map[string]any {
...
func (sdk *NarutoCharacterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NarutoCharacterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NarutoCharacterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NarutoCharacterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NarutoCharacterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NarutoCharacterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NarutoCharacterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NarutoCharacterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NarutoCharacterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NarutoCharacterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *NarutoCharacterSDK {
	...
	sdk := NewNarutoCharacterSDK(sdkopts)
	sdk.Mode = "test"
