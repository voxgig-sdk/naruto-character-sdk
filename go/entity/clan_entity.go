...
type ClanEntity struct {
	name    string
	client  *core.NarutoCharacterSDK
...
func NewClanEntity(client *core.NarutoCharacterSDK, entopts map[string]any) *ClanEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClanEntity) GetName() string { return e.name }
...
func (e *ClanEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClanEntity) Deleted() bool {
	return e.deleted
}


func (e *ClanEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClanEntity(e.client, opts)
}

func (e *ClanEntity) Data(args ...any) any {
...
func (e *ClanEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Clan; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClanEntity) DataTyped(data ...Clan) Clan {
	if len(data) > 0 {
		return typedFrom[Clan](e.Data(asMap(data[0])))
	}
	return typedFrom[Clan](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Clan (all fields
// optional at the wire level).
func (e *ClanEntity) MatchTyped(match ...Clan) Clan {
	if len(match) > 0 {
		return typedFrom[Clan](e.Match(asMap(match[0])))
	}
	return typedFrom[Clan](e.Match())
}
...
func (e *ClanEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClanEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ClanEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClanListMatch and returns []Clan. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ClanEntity) ListTyped(reqmatch ClanListMatch, ctrl map[string]any) ([]Clan, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Clan](res), nil
}



func (e *ClanEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClanEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClanEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClanEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
