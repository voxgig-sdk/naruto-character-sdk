...
// instead of `sdk.NewNarutoCharacterSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NarutoCharacterSDK  { return NewNarutoCharacterSDK(nil) }
func Test() *NarutoCharacterSDK { return TestSDK(nil, nil) }
